...
var BATCH = flag.Int("batch", 100, "the number of client requests in a batch")
...
func main() {
	...
	server.InitNode(lg, bls, info.IDType(config.Id), uint64(len(addrs)), config.Port, peers, pk, *BATCH)
}
